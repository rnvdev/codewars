/*
  ...
  one minute to traverse one city block, so create a function that will return true if the walk
...
function isValidWalk(walk) {
  ...
  console.log(isValidWalk(['s','w','n','s','w','s','w','s','w','s']));
  console.log(isValidWalk(['s','w','n','s','w','s','w','s','w','w']));
  console.log(isValidWalk(['s','w','n','s','w','s','w','s','w']));
  console.log(isValidWalk(['s','w','n','s','w','s','w','s','w','s','w']));